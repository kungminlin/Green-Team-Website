						...
						<ul>
							...
							<li class="submenu">
								...
								<ul>
									...
									<li><a href="pages/events.php">EVENTS AND CONFERENCES</a></li>
...
<!-- 									<li class="submenu">
			...
			<!-- CTA -->
				<section id="cta">
					...
					<footer>
						<ul class="buttons">
							<li><a href="pages/events.php" class="button special">Events</a></li>
							<li><a href="mailto:lahsgreenteam@gmail.com" class="button">Email Us</a></li>
						</ul>
					</footer>
